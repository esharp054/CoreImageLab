...
SWIFT_MODULE_NAMESPACE_PUSH("ImageLab")
@class UIWindow;

SWIFT_CLASS("_TtC8ImageLab11AppDelegate")
...
SWIFT_CLASS("_TtC8ImageLab14VideoAnalgesic")
@interface VideoAnalgesic : NSObject <AVCaptureAudioDataOutputSampleBufferDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
